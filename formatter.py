...
class RouteFormatter:
    ...
    def format_route_output(
        ...
        """
        Formatiert die Routen für die Konsolenausgabe
        
        Args:
            routes: Liste von Routen (jede Route ist eine Liste von RouteSegment-Objekten)
        ...
        for route_idx, route in enumerate(routes, 1):
            if route_idx > 1:
                output.append("")  # Leerzeile zwischen Routen
                output.append("=" * 50)
